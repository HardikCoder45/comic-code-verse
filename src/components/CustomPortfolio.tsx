...
const CustomPortfolio = () => {
  ...
  // Generate HTML whenever portfolio data changes
  useEffect(() => {
    if (name || title || bio || projects.length > 0 || skills.length > 0) {
      generatePortfolioHTML();
    }
  }, [name, title, bio, projects, skills, theme, layout, socialLinks, previewUrl]);
    ...
    <div className="min-h-screen w-full py-6 px-4 md:px-8 bg-gradient-to-b from-blue-50 to-white">
      <div className="max-w-6xl mx-auto">
        ...
        {viewMode === 'form' ? (
            ...
            <div className="lg:col-span-1">
              <div className="bg-white p-4 rounded-lg shadow-md border border-gray-200 h-full">
                <h3 className="font-bold text-lg text-gray-800 mb-4 flex items-center">
                  <Image className="mr-2 h-5 w-5" /> Live Preview
                </h3>
                          ...
                          {skills.map((skill) => (
                            <span 
                              ...
                              className={`px-2 py-1 text-xs rounded ${
                                ...
                                theme === 'pink' ? 'bg-pink-100 text-pink-700' :
                                theme === 'red' ? 'bg-red-100 text-red-700' :
                ...
                <div className="mt-4">
                  <Button 
                    ...
                    onMouseEnter={() => playSound('hover')}
                  >
                    <Code className="mr-2 h-4 w-4" /> View HTML & Preview
                  </Button>
                </div>
              </div>
            </div>
          ...
          // HTML Preview view
          <div className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden h-[calc(100vh-220px)]">
            {isHTMLGenerating ? (
              ...
              <div className="h-full w-full flex items-center justify-center">
                <div className="text-center p-8">
                  ...
                  <h3 className="text-lg font-medium text-gray-700 mb-2">No Portfolio Generated Yet</h3>
                  <p className="text-gray-500 mb-6">Fill in your information in the form to generate your portfolio HTML.</p>
                  <Button 
                    onClick={() => {
                      setViewMode('form');
                      playSound('click');
