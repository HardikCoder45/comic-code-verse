          ...
          <div className="max-w-3xl mx-auto mb-6">
            <SpeechBubble type="shout" color="blue">
              <p className="font-comic text-lg text-gray-800">
                Create your custom portfolio in minutes with AI assistance! Fill in your details or let AI generate a portfolio based on your description.
              </p>
            </SpeechBubble>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <Select onValueChange={(value) => playSound('click')}>
