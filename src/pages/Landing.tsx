...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-comic-background" ref={containerRef}>
      {/* Hero Section */}
        ...
        <div className="relative max-w-6xl mx-auto text-center px-4 z-10">
          ...
          >
            <a 
              ...
              className="inline-flex items-center space-x-2 font-comic text-black bg-white rounded-full px-4 py-2 border-2 border-black hover:bg-gray-100 transition-colors shadow-md"
            >
              <Github size={18} />
      ...
      <div className={`py-16 px-4 transition-all duration-1000 ${showElements.skills ? 'opacity-100' : 'opacity-0 translate-y-10'}`}>
        <div className="max-w-6xl mx-auto">
          <motion.h2 
            className="font-bangers text-4xl md:text-6xl text-comic-green text-center mb-12"
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 md:gap-6">
            <motion.div 
              className="bg-white rounded-xl border-4 border-comic-border p-4 flex flex-col items-center shadow-lg hover:shadow-xl transition-shadow"
            ...
            >
              ...
              <div className="w-full bg-gray-200 rounded-full h-2 mb-1">
                <div className="bg-comic-blue h-2 rounded-full" style={{ width: '95%' }}></div>
              </div>
            ...
            >
              ...
              <div className="w-full bg-gray-200 rounded-full h-2 mb-1">
                <div className="bg-comic-pink h-2 rounded-full" style={{ width: '90%' }}></div>
              </div>
            ...
            >
              ...
              <div className="w-full bg-gray-200 rounded-full h-2 mb-1">
                <div className="bg-comic-green h-2 rounded-full" style={{ width: '92%' }}></div>
              </div>
            ...
            >
              ...
              <div className="w-full bg-gray-200 rounded-full h-2 mb-1">
                <div className="bg-comic-orange h-2 rounded-full" style={{ width: '88%' }}></div>
              </div>
            ...
            >
              ...
              <div className="w-full bg-gray-200 rounded-full h-2 mb-1">
                <div className="bg-comic-purple h-2 rounded-full" style={{ width: '85%' }}></div>
              </div>
            ...
            >
              ...
              <div className="w-full bg-gray-200 rounded-full h-2 mb-1">
                <div className="bg-comic-blue h-2 rounded-full" style={{ width: '80%' }}></div>
              </div>
            ...
            >
              ...
              <div className="w-full bg-gray-200 rounded-full h-2 mb-1">
                <div className="bg-comic-pink h-2 rounded-full" style={{ width: '88%' }}></div>
              </div>
            ...
            >
              ...
              <div className="w-full bg-gray-200 rounded-full h-2 mb-1">
                <div className="bg-comic-green h-2 rounded-full" style={{ width: '85%' }}></div>
              </div>
            ...
            >
              ...
              <div className="w-full bg-gray-200 rounded-full h-2 mb-1">
                <div className="bg-comic-orange h-2 rounded-full" style={{ width: '80%' }}></div>
              </div>
            ...
            >
              ...
              <div className="w-full bg-gray-200 rounded-full h-2 mb-1">
                <div className="bg-comic-purple h-2 rounded-full" style={{ width: '95%' }}></div>
              </div>
      ...
      <div className={`py-16 px-4 transition-all duration-1000 ${showElements.features ? 'opacity-100' : 'opacity-0 translate-y-10'}`}>
        ...
        >
          <motion.h2 
            className="font-bangers text-4xl md:text-6xl text-comic-purple text-center mb-12"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Comic3DPanel 
              title="Interactive 3D Panels" 
              headerColor="blue"
              backgroundImage={backgroundImages[1]}
              className="hover:scale-105 transition-transform duration-300"
              spotlightEffect={true}
            >
              <p className="font-comic mb-4 text-black">Dynamic 3D panels with spotlight tracking and parallax effects for immersive display of project details.</p>
            ...
            <Comic3DPanel 
              title="Comic Book Page Flip" 
              headerColor="pink"
              backgroundImage={backgroundImages[0]}
              className="hover:scale-105 transition-transform duration-300"
              spotlightEffect={true}
            >
              <p className="font-comic mb-4 text-black">Realistic page-turning animations with shadow effects for an authentic comic book reading experience.</p>
              <div className="mt-4 flex justify-center">
                <div className="relative">
            ...
            <Comic3DPanel 
              ...
              spotlightEffect={true}
            >
              <p className="font-comic mb-4 text-black">Custom-built AI assistant using the Groq API with Llama 4 Model for helping visitors navigate the portfolio.</p>
              <div className="mt-4 flex justify-center">
                <div className="relative">
      ...
      <div className={`py-16 px-4 bg-gradient-to-b from-white to-comic-background transition-all duration-1000 ${showElements.portfolio ? 'opacity-100' : 'opacity-0 translate-y-10'}`}>
        ...
        >
          <motion.h2 
            className="font-bangers text-4xl md:text-6xl text-comic-orange text-center mb-12"
            initial={{ scale: 0.9 }}
            whileInView={{ scale: 1 }}
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Comic3DPanel 
              ...
              headerColor="green"
              backgroundImage="https://images.unsplash.com/photo-1639762681057-408e52192e55?auto=format&fit=crop&q=80&w=800"
              spotlightEffect={true}
              className="h-full"
            >
              <div className="relative h-full">
                <div className="absolute top-2 right-2 bg-comic-green text-white font-bangers px-2 py-1 rounded-lg rotate-6 z-10">HOT!</div>
                <p className="font-comic mb-4 text-black">Interactive blockchain data visualizer with real-time transaction tracking.</p>
                <div className="mt-4 flex flex-wrap gap-2">
                ...
                <div className="mt-6 space-y-3">
                  <div className="flex items-center">
                    ...
                    <span className="font-comic text-sm text-black">500,000+ Transactions Processed</span>
                  </div>
                  <div className="flex items-center">
